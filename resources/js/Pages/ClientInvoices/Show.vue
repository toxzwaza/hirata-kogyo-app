...
const clientItems = computed(() => {
    ...
    return props.invoice.staff_invoice_items.map((item) => {
        ...
        // 金額（税抜き）
        const amount = parseFloat(staffInvoice?.subtotal || 0);
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <!-- 差額調整フォーム -->
                <div v-if="showAdjustmentForm && invoice.status === 'draft'" class="mb-6 bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                ...
                <!-- 二枚目以降: スタッフごとの内訳 -->
                <div v-for="(items, staffName) in groupedStaffItems" :key="staffName" class="mt-8">
                    <Invoice
                        type="client-detail"
